...
public class CustomSpinnerAdapterStudent extends ArrayAdapter {
    ...
    public CustomSpinnerAdapterStudent(Context context, int resource, List objects) {
    ...
    private View createItemView(int position, View convertView, ViewGroup parent) {
        ...
        TextView nametextview = (TextView) view.findViewById(R.id.textview_custom_student);
