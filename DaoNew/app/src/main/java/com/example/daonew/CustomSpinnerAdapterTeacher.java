...
public class CustomSpinnerAdapterTeacher extends ArrayAdapter {
    ...
    public CustomSpinnerAdapterTeacher(Context context, int resource, List objects) {
    ...
    private View createItemView(int position, View convertView, ViewGroup parent) {
        ...
        TextView nametextview = (TextView) view.findViewById(R.id.textview_custom_spinner);
